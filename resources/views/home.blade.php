		...
		<div class="container">
			<div class="row align-items-center justify-content-between pt-5">
				<div class="col-lg-6 text-center text-lg-start pe-lg-5">
					<h1 class="heading text-white mb-3" data-aos="fade-up">LOWONGAN PEKERJAAN UNTUK ALUMNI!</h1>
					<div class="align-items-center mb-5 mm" data-aos="fade-up" data-aos-delay="200">
					</div>
				</div>
				<div class="col-lg-6" data-aos="fade-up" data-aos-delay="300">
					<div class="">
						<img src="img/loker.png" alt="Image" class="img-fluid" width="100%">
					</div>
				</div>
			</div>
		</div>
...
<div class="section sec-news">
	<div class="container">
		<div class="row mb-5">
			<div class="col-lg-7">
				<h2 class="heading text-primary">Lowongan Kerja</h2>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-lg-4">
				<div class="card post-entry">
					<a href="single.html"><img src="images/loker1.jpeg" class="card-img-top" alt="Image"></a>
					<div class="card-body">
			...
			<div class="col-lg-4">
				<div class="card post-entry">
					<a href="single.html"><img src="images/loker2.jpg" class="card-img-top" alt="Image"></a>
					<div class="card-body">
						<div><span class="text-uppercase font-weight-bold date">Jan 20, 2021</span></div>
						<h5 class="card-title"><a href="single.html">Behind the word mountains</a></h5>
						<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. </p>
